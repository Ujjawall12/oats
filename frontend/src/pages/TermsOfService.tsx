...
const TermsOfService = () => {
  useEffect(() => {
    document.title = "Terms of Service - Golden Oats";
  }, []);
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing and using the Golden Oats website and services, you accept and agree to be bound by the terms and provision of this agreement. These Terms of Service govern your use of our website, products, and services.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Permission is granted to temporarily download one copy of the materials on Golden Oats' website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
              </p>
            ...
            <section>
              <h2 className="text-2xl font-light text-foreground mb-4">Quality Guarantee</h2>
              <p className="text-muted-foreground leading-relaxed">
                Our products come with a quality guarantee. We guarantee that our oats are fresh, properly packaged, and meet our quality standards. If you're not satisfied with your purchase, please contact us within 30 days for a full refund. Proper storage instructions are provided with each purchase and on our website.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                All content on this website, including but not limited to text, graphics, logos, images, and software, is the property of Golden Oats and is protected by copyright, trademark, and other intellectual property laws. Unauthorized use is prohibited.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                In no event shall Golden Oats or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on our website or products, even if we have been notified of the possibility of such damage.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="mt-4 text-muted-foreground">
                <p>Email: legal@goldenoats.com</p>
                <p>Phone: +1 (612) 555-0123</p>
                <p>Address: 789 Farm Road, Minnesota, MN 55001</p>
              </div>
            </section>
          </div>
        </div>
